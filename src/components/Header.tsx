        ...
        <div className='z-40'>
            <header className='bg-primary flex items-center justify-between px-6 md:px-14  shadow-xl w-full z-40' ref={header}>
                ...
                <div className='flex text-white gap-8 items-center'>
                    ...
                    <button id="burguerMenu" className={IsMenuOpened ? 'hiddenIcon hiddenIcon-active flex md:hidden' : 'hiddenIcon flex md:hidden'} onClick={() => setIsMenuOpened(!IsMenuOpened)}>
